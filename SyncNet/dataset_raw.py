        ...
        with open(dataset_file_name) as listfile:
            while True:
                ...
                if len(data) == 4:
                    ...
                    raise;
        #self.data_list = self.data_list[:64]### Initialize Workers...        
        ### Initialize Workers...
    ...
    def dataLoaderThread(self, nThreadIndex):
        ...
        while(True):
            ...
            for filename in self.data_epoch[index:index+self.batch_size]:
                ...
                #print(get_frames(filename[0], max_frames=self.nMaxFrames, start_frame=startidx+offset-1).shape, filename)
