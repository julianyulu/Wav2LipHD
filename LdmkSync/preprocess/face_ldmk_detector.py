...
def process_fn(img_dir):
    ...
    for img_file in imgs:
        ...
        ldmk = ldmk[0].flatten().tolist()
        #ldmk = ldmk[0][49-1: 68 + 1 - 1, :].flatten().tolist() # ONLY lip: id: 49 ~ 68 are 20 lip ldmks (idx starts from 1)
        res[num]=ldmk
...
if __name__ == '__main__':
    ...
    processed_data_dir = '/data/julianlu/Experiment/Wav2LipHD/preprocessed_data/mix_ZYDH6PAD50_LRS3SPK90'
